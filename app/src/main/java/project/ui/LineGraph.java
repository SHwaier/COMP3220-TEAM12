...
/**
 * A JPanel that displays a line graph of the records in the RecordsList.
 */
public class LineGraph extends JPanel {
    ...
    /**
     * Creates a new LineGraph with the given RecordsList.
     * 
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color[] baseColors = { new Color(0, 102, 204), Color.BLUE, Color.ORANGE, Color.RED, Color.GREEN,
                Color.MAGENTA };
        ...
        double maxDataValue = records.getAllRecords().stream().mapToDouble(r -> r.getAmount() / SCALE_FACTOR).max()
                .orElse(1.0);
        ...
        g2d.drawString("Power Generated (Megawatts)",
                -panelHeight / 2 - fm.stringWidth("Power Generated (Megawatts)") / 2, 20);
        g2d.rotate(Math.PI / 2);
